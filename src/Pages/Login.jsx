...
export const Login = () => {
  ...
  const handleSubmit=(e)=>{
       e.preventDefault()
       axios.post("https://reachhub-l2zo.onrender.com/users/login",state)
       .then((res)=>{
        if(res.data.token){
        ...
        localStorage.setItem("token",res.data.token);
         ...
         toast({
          ...
          description: "You have been redirected to home page. Enjoy your read.",
          status: 'success',
          duration: 3000,
           position: "top",
          isClosable: true,
  ...
  return (
    ...
    <Navbar/>
    {
      (!auth) && <Text  fontWeight={"semibold"} > Login first to go to Home</Text>
    }
